...
namespace TaskAPI.Web.Common
{
    public class NamespaceHttpControllerSelector
    {
        ...
        public IDictionary<string, HttpControllerDescriptor> GetController()
        {
            return _controllers.Value;
        }

        private Dictionary<string, HttpControllerDescriptor> InitialControllerDictionary()
        {
